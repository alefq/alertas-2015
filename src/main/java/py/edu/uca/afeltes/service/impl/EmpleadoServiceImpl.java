package py.edu.uca.afeltes.service.impl;
...
import py.edu.uca.afeltes.domain.Empleado;
import py.edu.uca.afeltes.domain.Usuario;
import py.edu.uca.afeltes.service.EmpleadoService;
import py.edu.uca.afeltes.web.controller.EmpleadoController;
import py.edu.uca.afeltes.web.dto.EmpleadoDTO;
import py.edu.uca.afeltes.web.repository.EmpleadoRepository;
...
public class EmpleadoServiceImpl implements EmpleadoService {
     ...
     * 
     * @see
     * py.edu.uca.afeltes.service.EmpleadoService#updateEmpleado(py.edu.uca.afeltes.
