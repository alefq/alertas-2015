package py.edu.uca.afeltes.web.response;

import py.edu.uca.afeltes.web.dto.DefaultResponseDTO;
import py.edu.uca.afeltes.web.dto.MessageDTO;
import py.edu.uca.afeltes.web.enums.ErrorCode;
import py.edu.uca.afeltes.web.exceptions.ServiceException;
